            ...
            <section className="text-gray-700 dark:text-gray-400 body-font bg-light-100 dark:bg-deep-900">
                <div className="container px-5 pt-28 pb-10 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">With DreamlyMusic, you can listen and download over 80 million songs (number of songs available on JioSaavn) for FREE without any ads!</p>
                    </div>
